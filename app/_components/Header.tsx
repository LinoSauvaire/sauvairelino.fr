  ...
  return (
    <>
      ...
      <a 
        ...
        className="absolute top-4 md:top-8 lg:top-12 right-4 md:right-8 lg:right-12 px-3 md:px-[18px] py-2 md:py-2.5 rounded-full bg-gradient-to-r from-[#7C3AED] to-[#9333EA] text-white text-[11px] md:text-[13px] font-semibold shadow-[0_0_20px_rgba(124,58,237,0.5)] hover:shadow-[0_0_30px_rgba(124,58,237,0.7)] transition-all z-10 inline-block"
      >
        Télécharger CV
      </a>
    </>
